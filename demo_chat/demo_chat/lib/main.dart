...
Future main() async {
  ...
  final channel = await StreamApi.createChannel(
    ...
    image: 'https://www.oetker.co.uk/Recipe/Recipes/oetker.co.uk/uk-en/baking/image-thumb__3337__RecipeDetailsLightBox/sprinkles-birthday-cake.jpg',
...
class MyHomePage extends StatefulWidget {
  final Client client;
  final Channel channel;
  MyHomePage({Key key, this.title, this.client, this.channel}) : super(key: key);
